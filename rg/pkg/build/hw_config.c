...
extern char *act_atheros_vap_ifname;
extern char *act_atheros_vap_1_ifname;
...
void hardware_features(void)
{
	...
	if (token_get("CONFIG_HW_MOCA"))
	{
	    ...
	    /* XXX may not be reqired anymore */
	    token_set_y("CONFIG_RG_LIMITED_CPP");
	    token_set_y("CONFIG_RG_CXX");
	...
	/* USB */
    /* XXX Needed for Atheros Wireless to work */
	token_set_y("CONFIG_USB");
	token_set_m("CONFIG_USB_DWC_OTG");
	token_set_y("CONFIG_USB_DEVICEFS");
	    ...
	    token_get("CONFIG_RG_ATHEROS_HW_AR5416"))
	{
		...
		atheros_ar5xxx_add(act_wifi_ap_ifname, 
			act_atheros_vap_ifname, act_atheros_vap_1_ifname, NULL);
		dev_set_dependency(act_atheros_vap_ifname, act_wifi_ap_ifname);
		dev_set_dependency(act_atheros_vap_1_ifname, act_wifi_ap_ifname);
	    }
	    else
	    {
		atheros_ar5xxx_add(act_wifi_ap_ifname, act_atheros_vap_ifname, NULL);
		dev_set_dependency(act_atheros_vap_ifname, act_wifi_ap_ifname);
	    }
