 ...
 *
 * Version:	$Id: ip_output.c,v 1.1.1.1.2.1.2.3 2008/07/21 21:36:54 dcao Exp $
 *
 * Authors:	Ross Biro
...
#if defined(CONFIG_IP_MROUTE) || defined(CONFIG_RG_IGMP_PROXY) || defined(CONFIG_RG_IGMP_PROXY_MODULE)
...
#endif
#ifdef ACTION_TEC_IGMP_SNOOPING
