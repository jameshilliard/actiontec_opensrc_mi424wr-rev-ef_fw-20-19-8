 ...
 *
 *  $Id: 8250.c,v 1.1.1.1.2.1 2007/08/17 03:12:15 jungo Exp $
 *
...
static int serial8250_startup(struct uart_port *port)
{
	 ...
	 */
#if !defined(CONFIG_SERIAL_8250_COMCERTO)
...
serial8250_set_termios(struct uart_port *port, struct termios *termios,
		       struct termios *old)
{
#ifndef CONFIG_MACH_ADI_FUSIV  /* setup in loader */
	struct uart_8250_port *up = (struct uart_8250_port *)port;
...
static int serial8250_console_setup(struct console *co, char *options)
{
        ...
        /* use whatever bootloader setting */
        return 0;
#else
	struct uart_port *port;
	int baud = 9600;
...
static int __init serial8250_init(void)
{
	...
	printk(KERN_INFO "Serial: 8250/16550 driver $Revision: 1.1.1.1.2.1 $ "
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Generic 8250/16x50 serial driver $Revision: 1.1.1.1.2.1 $");
