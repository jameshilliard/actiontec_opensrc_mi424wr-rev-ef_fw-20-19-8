...
char *act_atheros_vap_ifname;
char *act_atheros_vap_1_ifname;
...
/* ACTION_TEC */
static void actiontec_set_common_names(void)
{
    ...
    token_set("ACTION_TEC_ATHEROS_IFNAME", act_atheros_vap_ifname);
    token_set("ACTION_TEC_ATHEROS_1_IFNAME", act_atheros_vap_1_ifname);
    ...
    if (IS_DIST("MC524WR"))
    {
	token_set("ACTION_TEC_MODEL_NAME", "MI424WR-GEN2"); 
    }
...
//	enable_module("MODULE_RG_JVM");
	...
	*/
    ...
    else if (IS_DIST("MC524WR"))
    {
        ...
        act_atheros_vap_ifname="ath0";
        act_atheros_vap_1_ifname="ath1";
        ...
        if (!token_get("ACTION_TEC_SMALL_IMG"))
        {
            enable_module("MODULE_RG_WLAN_AND_ADVANCED_WLAN");
            enable_module("MODULE_RG_VLAN");
            if (!token_get("ACTION_TEC_NCS") && !token_is_y("ACTION_TEC_NCS"))
            enable_module("MODULE_RG_URL_FILTERING");
            enable_module("MODULE_RG_QOS");
        }
        ...
        if (!token_get("ACTION_TEC_SMALL_IMG"))
	{
        ...
        if (!token_get("ACTION_TEC_SMALL_IMG"))
	{
	    dev_add_to_bridge_if_opt(act_def_bridge_ifname, act_atheros_vap_ifname, "CONFIG_RG_ATHEROS_HW_AR5212");
	    //dev_add_to_bridge_if_opt(act_def_bridge_ifname, act_atheros_vap_ifname, "CONFIG_RG_ATHEROS_HW_AR5416");
	}
        ...
        else /*if (token_get("ACTION_TEC_NCS") && token_is_y("ACTION_TEC_NCS"))*/
        {
...
#if 0 //MI424WR use ath card
	if (token_get("CONFIG_RALINK_RT2561"))
	    enable_module("CONFIG_HW_80211G_RALINK_RT2561");
	else if (token_get("CONFIG_RALINK_RT2560"))
	    enable_module("CONFIG_HW_80211G_RALINK_RT2560");
	else
#endif
	    enable_module("CONFIG_RG_ATHEROS_HW_AR5212");
